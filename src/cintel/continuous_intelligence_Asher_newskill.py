...
Terminal command to run this file from the root project folder
    ...
    uv run python -m cintel.continuous_intelligence_Asher_newskill
...
DATA_FILE: Final[Path] = DATA_DIR / "system_metrics_Asher.csv"
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "system_assessment_Asher_newskill.csv"
...
MAX_ERROR_RATE: Final[float] = 0.005
MAX_AVG_LATENCY: Final[float] = 20.0
